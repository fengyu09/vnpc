<template>
  <div id="chat">
        ...
        <div class="video-top clearfix">
          <dl class="fl clearfix">
            ...
            <dd class="fl" v-if="liveData">
              <h3 class="nick-name">{{ liveData.nickname }}</h3>
              <p>
        ...
        <div class="git-box" @mouseleave="gitMsg = false">
          ...
          <div class="money-diamod">
            <p class="user-balance">
              <i></i>
              {{ balance ? balance : 0 }}
              <a href="javascript:;" @click="goRecharge">充值 ></a>
            </p>
            <p class="user-diamon">
              <i></i>
              {{ diamond ? diamond : 0 }}
      ...
      <div class="fr fr-container">
        ...
        <div class="fr chat-container" v-show="currType == 1">
          ...
          <div class="hellovip" v-if="vipShow">
            <div class="hyvip">
              <i class="vip-type">VIP{{ hyvip }}</i
              >贵族<i class="vip-name">{{ hyvipName }}</i
              >驾临直播间
            </div>
          </div>
            ...
            <ul class="chat-content" v-show="chatData">
              ...
              <li v-for="v in chatData">
                ...
                >
                  ...
                  <span class="say-content">
                    ...
                    &nbsp;
                    <img :src="v.icon" alt />
                    <i class="ljnum">x{{ v.ljNum }}</i>
                  </span>
                </section>
                <section
                  v-if="v.type == 'subscribe'"
                  :class="{
                    host: v.userType == 1,
                    admin: v.userType == 2,
                    ['vip' + v.vip]: v.userType == 0,
                ...
                >
                  ...
                  <div class="chitchat fl">
                    ...
                    <ul class="table height">
                      <li class="title">
                        <span>玩法</span><span>Số</span><span>Tỷ lệ cược</span
                        ><span>钻石</span>
                      </li>
                      <li
                        class="gt-item"
              ...
              <!-- <li class="new-follow">
                            <section class="clearfix">
                                <div class="chat-photo fl">
                                    <img alt="" data-src="../../assets/imgaes/chat/2.jpg" src="../../assets/imgaes/chat/2.jpg" lazy="loaded"></div>
                                <div class="chitchat fl">
                                    <div class="clearfix">
                                        <span class="nick-name fl active" style="font-size: 13px;">马飞飞</span>
                                        <span class="fr" style="font-size: 10px; color: rgb(153, 153, 153);">18:18</span>
                                    </div>
                                    <div class="type-period clearfix">
                                        <span class="fl">幸运飞艇</span>
                                        <span class="fr">267366763期</span>
                                    </div>
                                    <ul class="table height">
                                        <li class="title"><span>玩法</span><span>号码</span><span>赔率</span><span>钻石</span></li>
                                        <li class="gt-item">
                                            <span>冠军</span><span>7</span><span>2.1</span><span>100</span>
                                        </li>
                                        <li class="gt-item">
                                            <span>冠军</span><span>7</span><span>2.1</span><span>100</span>
                                        </li>
                                    ...
                                    <p class="btn-group">
                                        <span class="open-up" @click="showAll($event)">展开 <img class="icon" src="../../assets/imgaes/chat/zk-min.png" alt=""></span>
                                        <span class="put-away" style="display: none" @click="hideAll($event)">收起 <img class="icon" src="../../assets/imgaes/chat/sq-min.png" alt=""> </span>
                                        <button class="follow-up" @click="followOrder()">跟投</button>
                                    </p>
                                </div>
                            </section>
                        </li> -->
          ...
          <div class="footer-input">
            <div class="beyond-txt" v-if="isLenght">{{ chatErr }}</div>
            <div class="say-box">
              <input
                @click="isLogin"
                id="textInput"
    ...
    >
      <div class="clearfix top-title">
        <div class="fl">
          <h3>
            历史开奖
            <i>- {{ lottery_id | filterLotteryName }}</i>
          </h3>
        </div>
      ...
      >
        <!-- 重庆时时彩 -->
        <table v-if="lottery_id == 1 || lottery_id == 10" class="table_3">
          <tr>
            <th>Thời gian</th>
            <th>期次</th>
            <th>
    ...
    <div class="vipChat-dialog">
      ...
      >
        <div class="baoshi">
          <div :class="{ active: baoshiItem == 1 }" @click="baoshiItem = 1">
            <p>10分钟</p>
            <p style="font-size: 16px">
              200
              <img src="../../assets/imgaes/zs_5_16icon.png" alt="" srcset="" />
            </p>
          </div>
          <div :class="{ active: baoshiItem == 2 }" @click="baoshiItem = 2">
            <p>60分钟</p>
            <p style="font-size: 16px">
              200
              <img src="../../assets/imgaes/zs_5_16icon.png" alt="" srcset="" />
          ...
          <div :class="{ active: baoshiItem == 3 }" @click="baoshiItem = 3">
            <p>包场</p>
            <p style="font-size: 16px">
              500
              <img src="../../assets/imgaes/zs_5_16icon.png" alt="" srcset="" />
        ...
        <div class="tovip-dialog-footer" style="margin-top: 40px">
          <!-- <div class="red-btn" @click="torecharge">Nạp</div>
   <div @click="torecharge">去兑换</div> -->
          <div :class="{ 'max-btn': true, 'active-btn': baoshiItem != '' }">
            Xác nhận
          </div>
        </div>
      </el-dialog>
      ...
      >
        ...
        <div class="tovip-dialog-footer" style="margin-top: 40px">
          <div class="red-btn" @click="torecharge">Nạp</div>
          <div @click="torecharge">自动退出(56s)</div>
        </div>
      </el-dialog>
      <el-dialog
      ...
      >
        <p style="margin-bottom: 30px">
          您观看的时间已经结束，请选择继续观看的方式
        </p>
        <div class="baoshi">
          <div :class="{ active: baoshiItem2 == 1 }" @click="baoshiItem2 = 1">
            <p>10分钟</p>
            <p style="font-size: 16px">
              200
              <img src="../../assets/imgaes/zs_5_16icon.png" alt="" srcset="" />
          ...
          <div :class="{ active: baoshiItem2 == 2 }" @click="baoshiItem2 = 2">
            <p>30分钟</p>
            <p style="font-size: 16px">
              200
              <img src="../../assets/imgaes/zs_5_16icon.png" alt="" srcset="" />
          ...
          <div :class="{ active: baoshiItem2 == 3 }" @click="baoshiItem2 = 3">
            <p>60分钟</p>
            <p style="font-size: 16px">
              300
              <img src="../../assets/imgaes/zs_5_16icon.png" alt="" srcset="" />
          ...
          <div :class="{ active: baoshiItem2 == 4 }" @click="baoshiItem2 = 4">
            <p>包场</p>
            <p style="font-size: 16px">
              500
              <img src="../../assets/imgaes/zs_5_16icon.png" alt="" srcset="" />
   ...
   <div @click="torecharge">去兑换</div> -->
          <div
            :class="{ 'max-btn': true, 'active-btn': baoshiItem2 != '' }"
...
export default {
  ...
  beforeCreate() {
    ...
    this.lottery_id = parseInt(this.$route.params.lotteryId) || 1;
  },
  beforeUpdate() {
  ...
  created() {
    ...
    this.lottery_id_cz = parseInt(this.$route.params.lotteryId) || 1; //原来的
    this.lottery_id = parseInt(this.$route.params.lotteryId) || 1;
    this.gethistoryList();
    this.init();
  ...
  mounted() {
    //  alertComfirm({ msg: "第一次进入直播间系统赠送您1分钟免费观看",title:'提示' }, () => {});
    // setTimeout(() => {
    //   alertComfirm({ msg: "体验已经结束，立即注册再送您5分钟 免费观看哟",title:'提示',showClose:true }, () => {
  ...
  methods: {
    ...
    muted(v) {
      if (v.user_id != this.UserId && this.userType == 2 && v.userType == 0) {
        this.isJy = true;
        this.jyTxt = v.userName;
        this.ban_user = v.user_id;
        // alertComfirm(
        //   { msg: "确定要对 '" + v.userName + "' 禁言30分钟吗？" },
        //   () => {
        //     this.$http({
        //       method: "post",
        //       url: this.versionLive2+"live/ban_words/",
        //       data: {
        //         opertate_user: this.UserId,
        //         ban_user: v.user_id,
        //         room_id: this.$route.params.id
        //       }
        //     })
    ...
    init() {
      ...
      if (JSON.parse(window.localStorage.getItem("vip")) > 0) {
        this.hyvip = window.localStorage.getItem("vip");
        this.hyvipName = window.localStorage.getItem("username");
        this.vipShow = true;
        setTimeout(() => {
          this.vipShow = false;
        }, 2000);
    ...
    SVGA(url, num, flag, sort) {
      ...
      if (flag == true || sort == "sort" || this.giftTime.length == 1) {
      ...
      this.$http
        ...
        .then((res) => {
          ...
          if (userAgent.indexOf("Firefox") > -1) {
            ...
            if (!this.player) {
              if (res.data.data.live_status) {
                this.player = new FlvPlayer({
                  id: "mse",
                  url: res.data.data.liveInfo[2].liveUrl.originPullUrl,
                  containerStyle: {
                    zIndex: 100,
                  },
            ...
            this.videoSrc = res.data.data.liveInfo[2].liveUrl.originPullUrl;
            this.playerOptions = {
    ...
    clearChatContent(i) {
      ...
      // //console.log(this.liveData.anchor_id)
      if (!this.$store.state.codeToken) {
        alertComfirm({ msg: "Đăng nhập để xem phiên bản đầy đủ" }, () => {
          this.$store.commit("SETLOGIN", true);
        });
    ...
    //预告
    getLivePreview(type) {
      this.$http.getthis.versionLive2 +
        ("user/anchor_advance/",
        {
          params: {
            user_id: "" || this.$store.state.userinfo.user_id,
    ...
    .chat-content {
      ...
      > li {
        ...
        .vip5 {
          ...
          &:before {
            background: url("../../assets/imgaes/chat/chat_icon.png") no-repeat;
            background-position: -56px -1137px;
          }
        }
        .vip6 {
          span:nth-child(1) {
